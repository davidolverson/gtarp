-- 0035_protection.sql — table for gtarp_protection. Apply after the qbx base schema.
...
-- only when a shakedown was reported (gtarp_evidence v2).
CREATE TABLE IF NOT EXISTS `gtarp_protection_collections` (
    ...
    INDEX idx_gtarp_protection_business_time (business_id, created_at),
    INDEX idx_gtarp_protection_gang (gang)
);
