-- 0030_onboarding.sql — tables for gtarp_onboarding. Apply after the qbx base schema.
...
CREATE TABLE IF NOT EXISTS `gtarp_onboarding` (
    id INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    citizenid VARCHAR(64) NOT NULL,
    accepted_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    starter_cash_granted TINYINT(1) NOT NULL DEFAULT 0,
    UNIQUE KEY uniq_gtarp_onboarding_citizenid (citizenid)
);
