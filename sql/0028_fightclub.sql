-- ============================================================================
-- 0028_fightclub.sql — palm6_fightclub ring matches + parimutuel bets.
--
...
--
-- palm6_fightclub_bets.UNIQUE(match_id, citizenid) is the load-bearing
...
-- resources/[custom]/palm6_fightclub/server/main.lua's module header.
-- ============================================================================
