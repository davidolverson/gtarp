-- ============================================================================
-- palm6_loanshark/shared/config.lua — engine-agnostic tunables (Tier 1).
...
-- (palm6_mdt), which palm6_bounty then auto-posts as a hunting contract. So the
...
-- (palm6_counterfeit's lane), NEVER the unregistered markedbills.
-- ============================================================================
Config = {}
...
-- Warrant issued on default (routed through palm6_mdt → palm6_bounty auto-posts
