...
--
-- Rate-limit / Reply / IsAdmin pattern mirrors palm6_citystats and palm6_season.
-- ============================================================================
...
local function dbg(msg)
    if Config.Debug then print('[palm6_help] ' .. msg) end
end

-- Per-source cooldown, one entry per command key (palm6_citystats idiom).
...
AddEventHandler('onResourceStart', function(resource)
    ...
    print('[palm6_help] command reference online, /help (any citizen)')
end)
