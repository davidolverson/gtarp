-- ============================================================================
-- palm6_blotter/shared/config.lua, engine-agnostic tunables (Tier 1, carries
-- to VI). Mirrors the Config shape of palm6_citations and palm6_ems.
--
...
-- (proven by palm6_citations Bridge.IsOnDutyPolice).
Config.PoliceJob = 'police'

-- Server console and this ace may run /blotter without the police gate, so
-- staff can pull the summary. Mirrors palm6_season Config.AdminAce.
...
-- palm6_discord's config (a live file we must not touch). When Enabled is
-- true and palm6_discord is started, a single timer thread posts one embed
