-- ============================================================================
-- gtarp_rapsheet/shared/config.lua, engine-agnostic tunables (Tier 1, carries
-- to VI). Mirrors the Config shape of gtarp_blotter and gtarp_citations.
--
...
-- job.onduty == true (proven by gtarp_citations / gtarp_blotter
-- Bridge.IsOnDutyPolice).
Config.PoliceJob = 'police'

-- Server console and this ace may run /priors without the police gate, so
-- staff can pull a citizen's sheet. Mirrors gtarp_blotter Config.AdminAce.
