-- ============================================================================
-- gtarp_clout/shared/config.lua — engine-agnostic tunables (Tier 1, carries
...
-- ---------------------------------------------------------------------------
-- Danger zones (gtarp_turf synergy — soft dependency).
...
-- the gtarp_turf table (refreshed every TurfRefreshSec); if that resource
-- or table is absent this silently never applies.
-- Zone ids + coords MUST mirror gtarp_turf's Config.Zones (Tier 3 coords).
-- ---------------------------------------------------------------------------
...
-- (gtarp_pumpcoin exchange #2) — same alley, different hustle.
-- ---------------------------------------------------------------------------
...
-- written to gtarp_clout_vod — who, what, where, when.
-- ---------------------------------------------------------------------------
...
-- log (gtarp_evidence synergy — soft dependency, skipped if absent).
