-- ============================================================================
-- palm6_rapsheet/server/main.lua
--
...
--   - palm6_citations      (0024): fine ledger. Outstanding = status in
...
--   - palm6_mdt_warrants   (0023): open orders. Active = status 'active';
--                           columns reason, officer_name, status, created_at.
--   - palm6_bounty_contracts (0027): wanted board. Active = status 'active'
...
local function dbg(msg)
    if Config.Debug then print('[palm6_rapsheet] ' .. msg) end
end
...
AddEventHandler('onResourceStart', function(resource)
    ...
    print('[palm6_rapsheet] read-only justice record online, /rapsheet (self), /priors (police)')
end)
