...
local function dbg(msg)
    if Config.Debug then print('[palm6_wanted] ' .. msg) end
end
...
local function cmdAmIWanted(src, _args)
    if src == 0 then
        print('[palm6_wanted] /amiwanted is a character self-check, run it in-game.')
        return
    end
...
AddEventHandler('onResourceStart', function(resource)
    ...
    print('[palm6_wanted] read-only wanted board online, /wanted (public), /amiwanted (self)')
end)
