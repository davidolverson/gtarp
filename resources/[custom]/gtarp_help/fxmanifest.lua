...
author 'Palm6'
version '0.1.0'
description 'gtarp help, a curated in-game command reference: /help lists the player-usable Palm6 custom commands by category, /help [topic] shows one category in detail'
