-- ============================================================================
-- gtarp_lottery/shared/config.lua - engine-agnostic tunables (Tier 1, carries
-- to VI). Mirrors the Config / Config.RateLimits shape from gtarp_citations
-- and gtarp_ems.
--
...
-- Per-source command cooldowns (seconds), mirroring gtarp_ems.RateLimits.
Config.RateLimits = {
    buy    = 3,
    status = 2,
    draw   = 5,
