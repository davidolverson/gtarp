-- ============================================================================
-- gtarp_wanted/shared/config.lua, engine-agnostic tunables (Tier 1, carries
-- to VI). Mirrors the Config shape of gtarp_blotter and gtarp_ems.
--
-- gtarp_wanted is a READ-ONLY, PLAYER-FACING civic surface: it owns no table
...
--
-- Distinct from gtarp_blotter: the blotter is an on-duty-POLICE enforcement
...
-- Per-source command cooldowns (seconds), mirroring gtarp_blotter.RateLimits.
Config.RateLimits = {
    wanted   = 5,
    amiwanted = 5,
}
