-- ============================================================================
-- gtarp_insurance/shared/config.lua — engine-agnostic tunables (Tier 1,
...
-- corresponding gtarp_replay incident scene is exactly as suspicious as it
-- sounds. Flagged claims still pay (48-slot trust server) but open a
-- gtarp_evidence case for police to work — insurance fraud is an RP hook,
