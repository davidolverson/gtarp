-- ============================================================================
-- palm6_evidence/client/main.lua
--
    ...
    while true do
        ...
        if Game.DistanceBetween(coords, Config.LockerCoords) <= Config.InteractRadius then
            ...
            if Game.InteractPressed() then
                TriggerServerEvent('palm6_evidence:requestOpenLocker')
            end
        end
...
RegisterNetEvent('palm6_evidence:openLocker', function(stashId)
    Game.OpenStash(stashId)
end)

RegisterNetEvent('palm6_evidence:showLog', function(content)
