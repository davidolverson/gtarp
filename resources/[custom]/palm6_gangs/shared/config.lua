-- ============================================================================
-- palm6_gangs/shared/config.lua — engine-agnostic tunables (Tier 1, carries
...
-- tables (palm6_gangs, palm6_gang_members, palm6_gang_vault_log) and expose
...
-- palm6_gang_members.rank stores these values.
