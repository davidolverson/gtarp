-- ============================================================================
-- palm6_gangs/bridge/sv_framework.lua
--
...
--
-- Our OWN SQL (palm6_gangs / palm6_gang_members / palm6_gang_vault_log) stays
...
-- framework-gang consumers (e.g. palm6_turf, which reads the qbx gang) reflect
