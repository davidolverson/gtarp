-- ============================================================================
-- palm6_seizure/bridge/sv_framework.lua
--
-- Framework adapter (server). The ONLY file in this resource that calls
-- qbx_core / ox_inventory / palm6_mdt / palm6_evidence exports or server-side
...
function Bridge.HasActiveWarrant(citizenid)
    ...
    local ok, has = pcall(function() return exports.palm6_mdt:HasActiveWarrant(citizenid) end)
    return ok and has == true
end

-- Soft cross-calls into palm6_evidence v2 (frozen exports; never its tables).
...
function Bridge.Notify(src, title, msg, t)
    if src == 0 then print(('[palm6_seizure] %s: %s'):format(title, msg)); return end
