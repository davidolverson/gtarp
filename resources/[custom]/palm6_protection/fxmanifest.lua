...
author 'EvThatGuy'
version '0.1.0'
description 'palm6 protection — turf-gated business extortion (makes holding turf pay)'
...
-- palm6_turf is a SOFT dependency (read via SQL cross-read, tolerated absent) —
