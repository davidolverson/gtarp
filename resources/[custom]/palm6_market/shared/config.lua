-- ============================================================================
-- palm6_market/shared/config.lua
--
-- The Palm6 Commodity Exchange: a server-authoritative, supply/demand market
-- for the LEGAL economy's raw goods (palm6_grind outputs). Prices move —
...
-- animal_pelt (palm6_grind mints it as a hunting drop but ships no buyer).
--
...
-- Interaction radius (metres) for the exchange counter. Matches palm6_grind.
...
-- restart- and relog-safe exactly like the grow/dry/cook timers in palm6_drugs.
-- ---------------------------------------------------------------------------
...
-- palm6_grind's fixed buyer price, shown on /market for comparison (nil means
...
-- palm6_ui panel styling for the /market price board (money green).
