-- ============================================================================
-- palm6_pumpcoin/shared/config.lua — engine-agnostic tunables (Tier 1,
...
-- Rug reveals write a fraud entry into the palm6_evidence table for
...
-- ---------------------------------------------------------------------------
-- Verified badge (palm6_turf synergy): if the creator's gang owns at least
