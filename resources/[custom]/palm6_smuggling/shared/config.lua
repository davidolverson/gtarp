-- ============================================================================
-- palm6_smuggling/shared/config.lua — engine-agnostic tunables (Tier 1).
...
--      launder through palm6_laundering and are seizable by palm6_seizure.
...
--   5. Real dispatch + a palm6_evidence trail, not qbx_drugs' random ping.
-- ============================================================================
Config = {}
