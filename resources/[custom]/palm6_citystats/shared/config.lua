-- ============================================================================
-- palm6_citystats/shared/config.lua, engine-agnostic tunables (Tier 1, carries
-- to VI). Mirrors the Config shape of palm6_blotter and palm6_economy.
--
...
-- Per-source command cooldown (seconds), mirroring palm6_blotter.RateLimits.
Config.RateLimits = {
    citystats = 10,
}
...
Config.Stats = {
    Gangs    = true,   -- palm6_gangs: count + city vault + top gangs by rep
    Members  = true,   -- palm6_gang_members: affiliated citizen count
    Drugs    = true,   -- palm6_drugs_sales: dirty moved + sale count in window
    Warrants = true,   -- palm6_mdt_warrants: active warrant count
}
