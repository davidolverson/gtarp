-- ============================================================================
-- palm6_flashdrop/bridge/sv_framework.lua
--
...
-- is known (same pattern as palm6_courier).
...
function Bridge.RegisterItem(name, def)
    ...
    print(('^1[palm6_flashdrop] FATAL: item %q is NOT registered with ox_inventory. '
...
function Bridge.Notify(src, title, msg, t)
    if src == 0 then
        print(('[palm6_flashdrop] %s: %s'):format(title, msg))
        return
    end
