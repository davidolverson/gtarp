...
author 'EvThatGuy'
version '0.1.0'
description 'gtarp ganginfo, read-only in-game public gang directory (/ganginfo, /gangs); creates no tables and writes nothing'

-- Server-only on purpose: this resource runs parameterized, read-only SELECTs
-- over tables other resources own (gtarp_gangs, gtarp_gang_members, gtarp_turf)
...
-- gtarp_gangs (which owns the /gang management menu and /gangweb), so nothing
