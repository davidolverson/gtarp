-- ============================================================================
-- gtarp_ganginfo/shared/config.lua, engine-agnostic tunables (Tier 1, carries
-- to VI). Mirrors the Config shape of gtarp_blotter.
--
...
-- Longest free-text blurb (gtarp_gangs.description) shown before it is trimmed.
